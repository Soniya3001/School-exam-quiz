...
export default function StudentLogin() {
  ...
  useEffect(() => {
    (async () => {
      ...
      if (stored) {
        ...
        setStudentSection(s.student_section || "");
  ...
  const onJoin = async () => {
    ...
    if (!studentSection) return setErr("Please select your section.");
      ...
      <KeyboardAvoidingView style={{ flex: 1 }} behavior={Platform.OS === "ios" ? "padding" : "height"}>
        <ScrollView contentContainerStyle={s.scroll}>
          ...
          <Card>
            ...
            <Picker label="Section" value={studentSection} onChange={setStudentSection} options={SECTIONS} testID="student-section-picker" />
            ...
            <Button
              title="Join & Start Test"
              onPress={onJoin}
              loading={loading}
              variant="accent"
              testID="student-join-btn"
            />
            {hasHistory && (
              <Button
