...
async def get_cbse_pattern(subject: str, topic: str, test_type: str) -> str:
    """Returns CBSE previous year question patterns for specific topic."""
    patterns = {
        "Mathematics": {
            "Real Numbers": {
                "mcq": "STRICTLY from Real Numbers only: HCF/LCM using prime factorization, Euclid division algorithm, prove irrational numbers (√2,√3,√5), decimal expansion (terminating/non-terminating), Fundamental Theorem of Arithmetic. Example CBSE MCQs: 'HCF of 96 and 404 is?', 'Which is irrational: √4, √9, √7, √16?', 'Decimal expansion of 17/8 is?'",
                "subjective": "Section A (1 mark): State Fundamental Theorem of Arithmetic / Write Euclid division lemma / Find HCF(26,91) / Express 156 as prime factors\nSection B (2 marks): Find HCF and LCM using prime factorization / Prove √2 is irrational / Use Euclid algorithm to find HCF(455,42)\nSection C (4 marks): Prove √5 is irrational / Prove 3+2√5 is irrational / Show any positive odd integer is of form 6q+1,6q+3 or 6q+5"
            },
            "Polynomials": {
                "mcq": "STRICTLY from Polynomials only: sum of zeros=-b/a, product of zeros=c/a, form polynomial from zeros, find zeros of quadratic, relationship between zeros and coefficients. Example CBSE MCQs: 'If α,β are zeros of 2x²-5x+7 then α+β=?', 'Quadratic polynomial with zeros -3 and 4 is?', 'Zeros of x²-2x-8 are?'",
                "subjective": "Section A (1 mark): Find zeros of x²-2x-8 / If α+β=5 and αβ=6 write the polynomial / Zeros of p(x)=x²-16\nSection B (2 marks): Find zeros of 4s²-4s+1 and verify relationship / If α,β zeros of 3x²+x-2 find 1/α+1/β / Find quadratic with sum=3 product=-4\nSection C (4 marks): If α,β zeros of x²-5x+6 form polynomial with zeros 1/α,1/β / Find all zeros of 2x⁴-3x³-3x²+6x-2 if two zeros are √2,-√2"
            },
            "Arithmetic Progressions": {
                "mcq": "STRICTLY from AP only: nth term an=a+(n-1)d, sum Sn=n/2[2a+(n-1)d], find common difference, which term of AP. Example CBSE MCQs: '10th term of 2,7,12... is?', 'Common difference of AP 3,1,-1,-3... is?', 'Sum of first 20 odd numbers is?'",
                "subjective": "Section A (1 mark): 20th term of AP 3,8,13... / Is 301 a term of AP 5,11,17...? / Find d if 3rd term=5 and 7th term=9\nSection B (2 marks): Find sum of first 20 terms of 1,3,5... / Which term of AP 3,8,13... is 78? / Find AP if sum of first 4 terms=28 and sum of first 8 terms=88\nSection C (4 marks): Sum of first n terms=3n²+5n, find AP and 20th term / A contract penalty Rs.200 first day increases Rs.50 daily — find penalty for 30 days"
            },
            "Triangles": {
                "mcq": "STRICTLY from Triangles only: BPT theorem, similar triangles (AA/SAS/SSS), ratio of areas=square of sides ratio, Pythagoras theorem. Example CBSE MCQs: 'In ΔABC DE||BC, AD=1.5 DB=3 AE=1, EC=?', 'If ΔABC~ΔPQR and AB/PQ=1/3, area ratio=?'",
                "subjective": "Section A (1 mark): State BPT / State Pythagoras theorem / In ΔABC DE||BC, AD=1.5 DB=3 AE=1 find EC\nSection B (2 marks): Prove areas of similar triangles ∝ square of corresponding sides / In right ΔABC AB=24 BC=7 find AC\nSection C (4 marks): Prove Basic Proportionality Theorem with diagram / Prove: In right triangle, square of hypotenuse = sum of squares of other two sides"
            },
            "Quadratic Equations": {
                "mcq": "STRICTLY from Quadratic Equations: nature of roots (discriminant b²-4ac), solve by factorization/formula, form equation from roots. Example CBSE MCQs: 'Discriminant of x²-3x+2=0 is?', 'Roots of 2x²-5x+3=0 are?'",
                "subjective": "Section A (1 mark): Find discriminant of x²-3x+2=0 / Nature of roots of 2x²+x+1=0\nSection B (2 marks): Solve 2x²-5x+3=0 by factorization / Find k if x²+4x+k=0 has equal roots\nSection C (4 marks): A train travels 360km at uniform speed. If speed increased by 5km/h, time reduced by 1hr. Find speed. / Two pipes fill tank in 9 and 10 hours. A drain empties in 12 hours. Find time to fill if all open."
            },
            "Introduction to Trigonometry": {
                "mcq": "STRICTLY from Trigonometry only: sin/cos/tan ratios, reciprocal identities, trigonometric values of 0°,30°,45°,60°,90°, basic identities sin²θ+cos²θ=1. Example CBSE MCQs: 'If sinA=3/4, cosA=?', 'Value of sin30°+cos60°=?', 'tan45°×cosec45°=?'",
                "subjective": "Section A (1 mark): Value of sin30°+cos60° / If tanθ=1 find θ / Write value of sin²θ+cos²θ\nSection B (2 marks): If sinθ=12/13 find cosθ and tanθ / Prove sinθ/(1-cosθ)=(1+cosθ)/sinθ\nSection C (4 marks): Prove (sinθ+cosecθ)²+(cosθ+secθ)²=7+tan²θ+cot²θ / If cosA=12/13, find sinA and verify sin²A+cos²A=1"
            },
        },
        "Science": {
            "Chemical Reactions and Equations": {
                "mcq": "STRICTLY from Chemical Reactions: types (combination/decomposition/displacement/double displacement), balancing equations, oxidation/reduction, exothermic/endothermic. CBSE MCQs: 'What type is 2Mg+O₂→2MgO?', 'Which is decomposition reaction?', 'Rusting of iron is which type?'",
                "subjective": "Section A (1 mark): Define exothermic reaction / What is oxidation? / Balance Fe+H₂O→Fe₃O₄+H₂\nSection B (2 marks): Write balanced equation for burning of magnesium, identify type / Difference between combination and decomposition reaction with examples\nSection C (4 marks): Explain redox reaction with example showing simultaneous oxidation and reduction / Write balanced equations for thermite reaction, fermentation of glucose, decomposition of silver chloride"
            },
            "Acids Bases and Salts": {
                "mcq": "STRICTLY from Acids Bases Salts: pH scale, indicators, neutralization, properties, common salts preparation. CBSE MCQs: 'pH of lemon juice is?', 'Which indicator turns red in acid?', 'Common salt formula?'",
                "subjective": "Section A (1 mark): What is pH of pure water? / Name the acid in vinegar / What happens when acid reacts with metal?\nSection B (2 marks): How is washing soda prepared? Write its use / What is neutralization? Give example\nSection C (4 marks): Explain properties of acids and bases with examples / Describe preparation and uses of baking soda and bleaching powder"
            },
            "Life Processes": {
                "mcq": "STRICTLY from Life Processes: photosynthesis equation, digestion enzymes, aerobic/anaerobic respiration, double circulation, excretion in humans. CBSE MCQs: 'Enzyme present in saliva is?', 'Site of photosynthesis?', 'Where does digestion of starch begin?'",
                "subjective": "Section A (1 mark): Name enzyme in saliva / Where does digestion of starch begin? / What is glycolysis?\nSection B (2 marks): Role of bile in digestion / Difference between aerobic and anaerobic respiration\nSection C (4 marks): Describe photosynthesis with equation and factors affecting it / Trace path of food from mouth to small intestine, name enzymes at each stage"
            },
        },
        "Social Science": {
            "The Rise of Nationalism in Europe": {
                "mcq": "STRICTLY from this chapter: French Revolution, Napoleonic Code, German unification, Italian unification, Bismarck, Garibaldi, Mazzini, Frankfurt Parliament. CBSE MCQs: 'Who was the architect of German unification?', 'Napoleonic Code was introduced in?'",
                "subjective": "Section A (1 mark): Who was Bismarck? / When was German Empire proclaimed? / Name female allegory of France\nSection B (2 marks): Role of Bismarck in German unification / Changes brought by Napoleon in conquered territories\nSection C (4 marks): Describe German unification process / How did nationalism emerge in Europe after French Revolution"
            },
            "Nationalism in India": {
                "mcq": "STRICTLY: Non-Cooperation Movement, Civil Disobedience, Salt March, Rowlatt Act, Jallianwala Bagh, INC, Gandhi, Khilafat. CBSE MCQs: 'Rowlatt Act was passed in?', 'Salt March started from?', 'Jallianwala Bagh massacre year?'",
                "subjective": "Section A (1 mark): When was Rowlatt Act passed? / Where did Dandi March begin? / What was Khilafat Movement?\nSection B (2 marks): Why was Non-Cooperation Movement withdrawn? / Significance of Salt March\nSection C (4 marks): Describe Civil Disobedience Movement / How did different social groups participate in Civil Disobedience Movement?"
            },
        },
    }

    subj_patterns = patterns.get(subject, {})
    topic_patterns = subj_patterns.get(topic, {})

    if not topic_patterns:
        # Generic fallback
        if test_type == "mcq":
            return f"Generate STRICTLY from '{topic}' chapter only. Do NOT include questions from any other chapter. All 4 options must be from {subject} Class concepts only."
        else:
            return f"Generate STRICTLY from '{topic}' chapter only as per CBSE pattern. Section A: definitions and one-line answers. Section B: short explanations and problems. Section C: detailed proofs and long answers."

    if test_type == "mcq":
        return topic_patterns.get("mcq", "")
    else:
        return topic_patterns.get("subjective", "")
...
async def generate_mcq(lesson_text, image_b64, count, test_class, subject, language, difficulty, api_key, system_msg, selected_topic: str = '') -> str:
    diff_map = {
        1: "Easy — direct recall, definitions, single-step.",
        2: "Medium — application of concepts and formulas.",
        3: "Hard — multi-step, analysis, higher order thinking.",
    }
    diff_desc = diff_map.get(int(difficulty), diff_map[2])

    cbse_pattern = await get_cbse_pattern(subject, selected_topic, "mcq") if selected_topic else ""
    topic_line = f"Topic: {selected_topic}\n{cbse_pattern}" if selected_topic else f"Cover important topics of {subject} Class {test_class}."
    ...
    prompt = (
        f"Create exactly {count} MCQ questions for Class {test_class} {subject} CBSE exam.\n"
        f"Difficulty: {diff_desc}\n"
        f"Language: {language}\n"
        f"{topic_line}\n\n"
        "STRICT RULES:\n"
        "1. ALL questions must be from the specified topic ONLY — no other chapter.\n"
        "2. Each question must have exactly 4 options, only 1 correct.\n"
        "3. All options must be plausible — no obviously wrong distractors.\n"
        "4. Follow CBSE board exam style exactly.\n\n"
        "Return ONLY valid JSON:\n"
        '{{"questions":[{{"q":"question","options":["A","B","C","D"],"answer":0}}]}}'
        "\nThe answer field = index (0,1,2,3) of the correct option."
        f"{lesson_line}"
    )
...
async def generate_subjective(lesson_text, image_b64, test_class, subject, language, api_key, system_msg, selected_topic: str = '') -> str:
    cbse_pattern = await get_cbse_pattern(subject, selected_topic, "subjective") if selected_topic else ""
    topic_line = f"Topic: {selected_topic}" if selected_topic else f"Important topics of {subject} Class {test_class}"
    ...
    cbse_note = f"\n\nCBSE PREVIOUS YEAR QUESTION PATTERN FOR THIS TOPIC:\n{cbse_pattern}" if cbse_pattern else ""

    prompt = (
        f"Create a 20 marks CBSE subjective question paper for Class {test_class} {subject}.\n"
        f"{topic_line}\n"
        f"Language: {language}\n"
        f"{cbse_note}\n\n"
        "Question format (follow exactly):\n"
        "- Section A: 4 questions x 1 mark (Very Short Answer)\n"
        "- Section B: 4 questions x 2 marks (Short Answer)\n"
        "- Section C: 2 questions x 4 marks (Long Answer)\n\n"
        "STRICT RULES:\n"
        "1. ALL questions from specified topic ONLY.\n"
        "2. Follow the CBSE previous year pattern given above.\n"
        "3. Section A: definitions, state theorems, one-line answers.\n"
        "4. Section B: short proofs, calculations, 2-3 step solutions.\n"
        "5. Section C: full proofs, detailed solutions, word problems.\n\n"
        "Return ONLY valid JSON:\n"
        '{{"questions":['
        '{{"q":"question","marks":1,"section":"A","expected_answer":"answer","keywords":["k1"]}},'
        '{{"q":"question","marks":2,"section":"B","expected_answer":"answer","keywords":["k1","k2"]}},'
        '{{"q":"question","marks":4,"section":"C","expected_answer":"answer","keywords":["k1","k2","k3"]}}'
        ']}}\n'
        "IMPORTANT: Return EXACTLY 4 with section=A marks=1, EXACTLY 4 with section=B marks=2, EXACTLY 2 with section=C marks=4."
        f"{lesson_line}"
    )
    return prompt, system_msg
...
async def generate_questions_llm(
    ...
    # ── Parse JSON response ──────────────────────────────────
    if not text:
        raise HTTPException(502, "AI returned empty response. Please try again.")
    ...
    try:
        ...
        if not questions:
            logger.error(f"AI returned no questions. Raw text: {text[:500]}")
            raise HTTPException(502, "AI returned no questions. Please try again.")
